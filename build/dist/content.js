...
(function(){
  var crypt = __webpack_require__(334),
      utf8 = __webpack_require__(130).utf8,
      isBuffer = __webpack_require__(335),
      bin = __webpack_require__(130).bin,
...
// CONCATENATED MODULE: ./src/content/MultiFetch.js
...
function () {
  function MultiFetch() {
    var worker = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 2;
  ...
  _createClass(MultiFetch, [{
    key: "_getHashCode",
    value: function _getHashCode() {
    ...
    value: function _fetchURL(url) {
      ...
      return new Promise(function (resolve, reject) {
        if (_this.urls2data.hasOwnProperty(url)) {
          if (_this.debug) console.log('URL=>', url);
          resolve(_this.urls2data[url]);
        } else if (url === undefined) {
          resolve(url);
        } else {
          var timeout = setTimeout(function () {
            if (_this.debug) console.log('TIMEOUT', url);
            resolve(url);
          }, 2000); // if( ( url.indexOf('://')>=0 && url.indexOf('http')<0 ) || url.indexOf('blob')>=0){
      ...
      if (this.urls.length == 0 && this.workerCount == 0 && !this.finish) {
        ...
        if (typeof url === 'string') {
          if (this.urls2data.hasOwnProperty(url)) {
            ...
            this._fetchURL(url).then(function (result) {
              _this2.data.push({
                url: url,
                data: result,
                "new": true
    ...
    value: function fetch(urls) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this3.data = [];
        _this3.urls = urls;
        _this3.success = resolve;
        _this3.urls = urls;

        if (_this3.urls.length === 0) {
          _this3.success(_this3.data);
        } else {
          for (var i = 0; i < _this3.worker; i++) {
            setTimeout(function (e) {
              return _this3._worker();
            }, _this3.getRandomNr(10, 200));
          }
        }
      });
    }
...
var eventemitter3 = __webpack_require__(131);
var eventemitter3_default = /*#__PURE__*/__webpack_require__.n(eventemitter3);

// CONCATENATED MODULE: ./src/content/Tracker.js
...
function Tracker_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function Tracker_createClass(Constructor, protoProps, staticProps) { if (protoProps) Tracker_defineProperties(Constructor.prototype, protoProps); if (staticProps) Tracker_defineProperties(Constructor, staticProps); return Constructor; }
  ...
  function Tracker(worker, privacy) {
    ...
    _this.eventFn = {
      onEvent: function onEvent(data) {
        _this.eventEmitter.emit(EVENT_NAMES.data, Object.assign(data, {
          timestamp: +new Date()
        }), false);
      }
    };
  ...
  Tracker_createClass(Tracker, [{
    ...
    */
    ...
    value: function _getElements() {
      var querys = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      ...
      console.assert(querys.length != 0, 'querys empty'); // console.log('querys', querys);
      ...
      try {
        for (var _iterator2 = querys[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var query = _step2.value;
          if (!options.ignoreTracked) query += options.filter; // console.log(target, query);

          var elements = target.querySelectorAll(query);
    ...
    key: "getAllMatches",
    value: function getAllMatches(regex, text) {
    ...
    key: "_getSourceLinks",
    value: function _getSourceLinks() {
      var dom = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
      var tags = this.getAllMatches(/<\b(link|meta|script|img|video)(.*?)\>/gi, dom);
      var attr = this.getAllMatches(/\"(.*?)\"/g, tags.join(' '));
      var a = this.getAllMatches(/("(.*?)\")/gi, attr.join(' '));
      var links = [];
    ...
    key: "_findParentElement",
    value: function _findParentElement(node, selector) {
      var stop_selector = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'body';
    ...
    value: function getParentElement(node, selector, stop_selector) {
      if (typeof selector == 'string') {
        ...
        try {
          for (var _iterator4 = selector[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  if (!(_this3.favicon == null)) {
                    _context.next = 18;
                    break;
                  }

                  link = _this3._getElements(['link[rel="icon"]', 'link[rel="shortcut icon"]'], undefined, {
                    setTracked: false
                  });
                  ...
                  _context.next = 8;
                  return _this3._fetchURL(link);

                case 8:
                  _this3.favicon = _context.sent;
                  resolve(_this3.favicon);
                  _context.next = 13;
                  break;
    ...
    value: function fetchSource(dom) {
      ...
      function () {
        ...
        regeneratorRuntime.mark(function _callee2(resolve, reject) {
          var source, CHUNKSIZE, sources, i;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 3:
                  ...
                  CHUNKSIZE = 50;
                  sources = [].concat.apply([], source.map(function (elem, i) {
          ...
          return regeneratorRuntime.wrap(function _callee6$(_context6) {
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  if (_this8.debug) console.log('fetchHTML: ' + new Date()); // sometimes the content is updated before the url, the timeout here
                    ...
                    return regeneratorRuntime.wrap(function _callee5$(_context5) {
                      while (1) {
                        switch (_context5.prev = _context5.next) {
                          case 0:
                            if (this.debug) console.log('timeout: FetchHTML'); // reset the credentials before anything else, this will turn on/off
                            // different flags for the creation of the DOM

                            this.reset_credentials(); // check if the URL has changed
...
// CONCATENATED MODULE: ./src/content/addon/FacebookTracker.js
function FacebookTracker_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { FacebookTracker_typeof = function _typeof(obj) { return typeof obj; }; } else { FacebookTracker_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return FacebookTracker_typeof(obj); }

function FacebookTracker_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function FacebookTracker_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { FacebookTracker_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { FacebookTracker_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

function FacebookTracker_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function FacebookTracker_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function FacebookTracker_createClass(Constructor, protoProps, staticProps) { if (protoProps) FacebookTracker_defineProperties(Constructor.prototype, protoProps); if (staticProps) FacebookTracker_defineProperties(Constructor, staticProps); return Constructor; }
...
function FacebookTracker_setPrototypeOf(o, p) { FacebookTracker_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return FacebookTracker_setPrototypeOf(o, p); }



var md5 = __webpack_require__(333);
...
function (_Tracker) {
  ...
  function FacebookTracker(worker, privacy) {
    ...
    if (_this.allow) {
      _this._joinGroup(); //never executes


      _this.documentHead = _this._getHead(); // console.log(this.documentWrapper);
    }

    _this.startswith_blacklist = ['/ads/activity/', '/crisisresponse/', '/events/', '/friends/', '/gaming/', '/jobs/', '/marketplace/', '/memories/', '/messages/', '/notifications/', '/offers/', '/photo/', '/recommendations/', '/saved/', '/settings/'];
  ...
  FacebookTracker_createClass(FacebookTracker, [{
    ...
    **/
    ...
    key: "_getValues",
    value: function _getValues(target) {
      var search = [{
        ...
        filter: function filter(e) {
          var re = /\b(\d+\.?\d*)(K?)\b/g;
          var matches = e.textContent.match(re);
          console.log(matches);

          if (matches === null) {
            return 1;
          } else {
            var lastElement = matches[matches.length - 1];
    ...
    key: "_isPublicOrLogInUser",
    value: function _isPublicOrLogInUser(target) {
      // try to detect if the is the same user as logged in
      var is_same = this.is_link_same_as_logged_user(target, '.fwn.fcg a');
    ...
    value: function _getPublicArticels() {
      ...
      var found = document.querySelectorAll('[data-pagelet^="FeedUnit"]:not(.tracked)'); // // try to capture elements in the new interface
      // if (found.length == 0){
      ...
      for (var i = 0; i < length; i++) {
        ...
        if (this._isPublicOrLogInUser(found[i])) {
          ...
          this._eventcommentFromCommentButton(found[i]); //this._setLikeCommentEvent(found[i]); //haven't been fixed and currently unsupported
      ...
      for (var i = 0; i < bucket.length; i++) {
        var privacy_icon = bucket[i].querySelector("span.g0qnabr5 > span > span > i");

        if (privacy_icon && privacy_icon.ariaLabel == 'Shared with Public' || privacy_icon && privacy_icon.ariaLabel == 'Shared with Public group' || privacy_icon && privacy_icon.ariaLabel == 'Shared with Custom' || privacy_icon && privacy_icon.ariaLabel == 'משותף עם קבוצה ציבורית' || privacy_icon && privacy_icon.ariaLabel == 'משותף עם ציבורי' || privacy_icon && privacy_icon.ariaLabel == 'משותף עם התאמה אישית') {
          savedElements.push(bucket[i]);
        }
      }

      this.totalPostsSeen += bucket.length; //return bucket.filter(e => e!=undefined);
        ...
        try {
          for (var _iterator2 = _this2.eventElements.commentButton[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            for (var i = 0; i < commentButtons.length; i++) {
              ...
              if (_this2.facebook_debug) commentButtons[i].setAttribute("style", "border:2px solid yellow !important;");
        ...
        try {
          for (var _iterator4 = _this4.eventElements.commentfields[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            ...
            for (var i = 0; i < commentfields.length; i++) {
              ...
              if (_this4.facebook_debug) commentfields[i].setAttribute("style", "border:2px solid pink !important;");
              commentfields[i].addEventListener('keydown', function (e) {
    ...
    value: function _setShareEvent(articel) {
      ...
      var findShareButton = function findShareButton() {
        var shareButton = document.querySelectorAll('[aria-label="Send this to friends or post it on your timeline."]:not(.tracked)');
        setTimeout(function () {
    ...
    key: "getValueOfLikeNumber",
    value: function getValueOfLikeNumber(nr) {
      var value = '';
            ...
            var _loop2 = function _loop2() {
              ...
              buttons[i].addEventListener('mouseenter', function () {
                setTimeout(function () {
                  ...
                  var toolbar = document.querySelector('div.j83agx80[role="toolbar"]');
                  var button = toolbar.querySelector('div');
                  button.addEventListener('click', function (e) {
    ...
    value: function _toolbarHandler() {
      ...
      var fetch = function fetch(layer) {
        var buttons = layer.querySelectorAll('[aria-label="Reactions"]:not(.tracked)');
      ...
      setTimeout(function () {
        ...
        var _loop3 = function _loop3(i) {
          ...
          layer[i].onmouseover = function (e) {
            layer[i].stop();
            fetch(layer[i]);
          };
            ...
            if (this.facebook_events_debug) buttons[i].addEventListener('mouseover', function (e) {
              ...
              _this9.eventFn.onEvent({
                ...
                values: [{
                  ...
                  name: 'count-Groupuser',
                  value: countGroupUser
                }, {
                  name: 'lastpost',
                  value: lastpost
                }]
    ...
    value: function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                /*#__PURE__*/
                function () {
                  var _ref = FacebookTracker_asyncToGenerator(
                  /*#__PURE__*/
                  regeneratorRuntime.mark(function _callee(resolve, reject) {
                    var found, i, cloned, commentator, j;
                    return regeneratorRuntime.wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            try {
                              ...
                              if (_this10.entries_found == 0) {
                                ...
                                for (i = 0; i < found.length; i++) {
                                  cloned = found[i].cloneNode(true);
                                  commentator = cloned.querySelectorAll('[class="pq6dq46d"]');

                                  for (j = 0; j < commentator.length; j++) {
                                    commentator[j].innerText = md5(commentator[j].innerText);
                                  }

                                  _this10.elements.push(found[i]); //is this being used anywhere?


                                  _this10.elementStrings += cloned.outerHTML;
                                }

                                resolve('<html totalPostsSeen="' + _this10.totalPostsSeen + '" >' + _this10._getHead() + '<body>' + _this10.elementStrings + '</body>' + '</html>');
                              }
                            } catch (err) {
                              reject(err);
                            }
      ...
      return function getDom() {
        return _getDom.apply(this, arguments);
      };
    }()
    /**
...
// CONCATENATED MODULE: ./src/content/addon/YouTubeTracker.js
function YouTubeTracker_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { YouTubeTracker_typeof = function _typeof(obj) { return typeof obj; }; } else { YouTubeTracker_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return YouTubeTracker_typeof(obj); }

function YouTubeTracker_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function YouTubeTracker_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function YouTubeTracker_createClass(Constructor, protoProps, staticProps) { if (protoProps) YouTubeTracker_defineProperties(Constructor.prototype, protoProps); if (staticProps) YouTubeTracker_defineProperties(Constructor, staticProps); return Constructor; }

function YouTubeTracker_possibleConstructorReturn(self, call) { if (call && (YouTubeTracker_typeof(call) === "object" || typeof call === "function")) { return call; } return YouTubeTracker_assertThisInitialized(self); }

function YouTubeTracker_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function YouTubeTracker_get(target, property, receiver) { if (typeof Reflect !== "undefined" && Reflect.get) { YouTubeTracker_get = Reflect.get; } else { YouTubeTracker_get = function _get(target, property, receiver) { var base = YouTubeTracker_superPropBase(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(receiver); } return desc.value; }; } return YouTubeTracker_get(target, property, receiver || target); }

function YouTubeTracker_superPropBase(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = YouTubeTracker_getPrototypeOf(object); if (object === null) break; } return object; }

function YouTubeTracker_getPrototypeOf(o) { YouTubeTracker_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return YouTubeTracker_getPrototypeOf(o); }

function YouTubeTracker_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) YouTubeTracker_setPrototypeOf(subClass, superClass); }

function YouTubeTracker_setPrototypeOf(o, p) { YouTubeTracker_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return YouTubeTracker_setPrototypeOf(o, p); }
...
function (_Tracker) {
  ...
  function YouTubeTracker(worker, privacy) {
    ...
    _this.is_correct_logged_fullname = false;
    _this.logged_fullname = null;
  ...
  YouTubeTracker_createClass(YouTubeTracker, [{
    key: "_getValues",
    value: function _getValues(target) {
      var search = [{
        name: 'articel-time',
      ...
      var is = this.values.filter(function (e) {
    ...
    */
    ...
    key: "getMetadata",
    value: function getMetadata() {
      var metadata = YouTubeTracker_get(YouTubeTracker_getPrototypeOf(YouTubeTracker.prototype), "getMetadata", this).call(this);
    ...
    key: "_get_logged_email",
    value: function _get_logged_email() {
      if (this.logged_email) {
      ...
      try {
        for (var _iterator3 = this.eventElements.logged_email[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    key: "_get_logged_fullname",
    value: function _get_logged_fullname() {
      ...
      try {
        for (var _iterator4 = this.eventElements.logged_fullname[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      ...
      var el = document.querySelector(this.eventElements.profile_pic_url_comment);
    ...
    key: "_get_profile_pic_url",
    value: function _get_profile_pic_url() {
      ...
      if (el) {
        ...
        try {
          for (var _iterator5 = this.eventElements.profile_pic_url_avatar[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
    ...
    value: function _isLogged() {
      if (document.querySelector('#avatar-btn')) {
        return true; // e.g. used in youtube.com/pair/     
    ...
    value: function _getRootElement() {
      if (this.rootElement == null) {
        var target = this._getElements(this.eventElements.root, document);
    ...
    key: "_setCategorie2Meta",
    value: function _setCategorie2Meta() {
      if (this.fetchCategorie.is || this.fetchCategorie.count >= this.fetchCategorie.MAX_COUNT) return;
      this.fetchCategorie.count += 1; // console.log('this.fetchCategorie.count', this.fetchCategorie.count);

      var contents = this._getElements(this.eventElements.categorie.contents, this._getRootElement(), {
        setTracked: false,
        color: 'purple'
      });
      ...
      try {
        for (var _iterator6 = contents[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      ...
      var more = this._getElements(this.eventElements.categorie.button.more, this._getRootElement(), {
        setTracked: false,
        color: 'purple'
      ...
      try {
        for (var _iterator7 = more[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
      ...
      var categories = this._getElements(this.eventElements.categorie.categories, this._getRootElement(), {
        setTracked: false,
        color: 'purple'
      ...
      try {
        for (var _iterator8 = categories[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
          ...
          this.updateMetaData({
            keywords: categorie.textContent
          });
        }
      } catch (err) {
        _didIteratorError8 = true;
      ...
      var less = this._getElements(this.eventElements.categorie.button.less, this._getRootElement(), {
        setTracked: false,
        color: 'purple'
      ...
      try {
        for (var _iterator9 = less[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
          var _button = _step9.value;
    ...
    key: "_eventSetLike",
    value: function _eventSetLike() {
      var _this3 = this;

      var buttons = this._getElements(this.eventElements.likearticelButton, this._getRootElement());
      ...
      for (var i = 0; i < buttons.length; i++) {
        buttons[i].addEventListener('click', function (e) {
          _this3.eventFn.onEvent({
            event: 'like',
            type: 'articel',
            values: _this3._getValues().concat([{
              name: 'like',
              value: 'like'
            }])
          });
    ...
    key: "_eventSetDislike",
    value: function _eventSetDislike() {
      var _this4 = this;

      var buttons = this._getElements(this.eventElements.dislikearticelButton, this._getRootElement());
      ...
      for (var i = 0; i < buttons.length; i++) {
        buttons[i].addEventListener('click', function (e) {
          _this4.eventFn.onEvent({
            event: 'like',
            type: 'articel',
            values: _this4._getValues().concat([{
              name: 'like',
              value: 'dislike'
            }])
          });
    ...
    key: "_eventSubscribe",
    value: function _eventSubscribe() {
      var _this5 = this;

      var buttons = this._getElements(this.eventElements.subscribeButton, this._getRootElement(), {
        color: 'blue'
      });
    ...
    key: "_eventNewComment",
    value: function _eventNewComment() {
      var _this6 = this;

      var inputs = this._getElements(this.eventElements.newComment, this._getRootElement(), {
        color: 'blue'
      });
      ...
      try {
        var _loop = function _loop() {
          ...
          input.addEventListener('click', function (e) {
            return setTimeout(function () {
              _this6._eventCommentDialog(input, function (comment) {
                _this6.eventFn.onEvent({
                  event: 'comment',
                  type: 'articel',
                  values: _this6._getValues().concat([{
                    name: 'comment',
                    value: comment
                  }])
                });
        ...
        for (var _iterator11 = inputs[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
          _loop();
        }
      } catch (err) {
    ...
    key: "_eventClickHashtag",
    value: function _eventClickHashtag() {
      var _this7 = this;

      var inputs = this._getElements(this.eventElements.hashtag, this._getRootElement(), {
        color: 'blue'
      });
      ...
      for (var i = 0; i < inputs.length; i++) {
        if (inputs[i].textContent.substring(0, 1) != '#') {
          ...
          inputs[i].addEventListener('click', function (e) {
            return _this7.eventFn.onEvent({
              event: 'hashtag',
              type: 'articel',
              values: _this7._getValues().concat([{
                name: 'name',
                value: e.srcElement.textContent
              }])
            });
    ...
    key: "_getValuesFromComment",
    value: function _getValuesFromComment(target) {
      //----content---
      var contentString = null;

      var content = this._getElements(this.eventElements.comment.content, target, {
        ignoreTracked: false
      });

      for (var c = 0; c < content.length; c++) {
        contentString = content[c].textContent;
      } //----time comment---


      var timeString = null;

      var timeContent = this._getElements(this.eventElements.comment.timeContent, target, {
        ignoreTracked: false
      });

      for (var t = 0; t < timeContent.length; t++) {
        timeString = timeContent[t].textContent;
      } //----countMiddle---


      var countMiddleInt = null;

      var countMiddle = this._getElements(this.eventElements.comment.countMiddle, target, {
        ignoreTracked: false
      });

      for (var cm = 0; cm < countMiddle.length; cm++) {
        countMiddleInt = parseInt(countMiddle[cm].textContent.replace(/\D+/g, ""), 10);
      }

      return {
        time: timeString,
        content: contentString,
        countMiddle: countMiddleInt
      };
    }
    /**
    ...
    key: "_eventCommentLike",
    value: function _eventCommentLike() {
      var _this8 = this;

      var target = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._getRootElement();
      var event = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
      var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.eventElements.commentWrapper[0];

      var wrappers = this._getElements(type.query, target, {
        color: 'blue'
      });
      ...
      try {
        var _loop2 = function _loop2() {
          ...
          if (_this8.youtube_debug) {
            if (type.name == 'postanswer') {
              ...
              _this8._setBorder(wrapper, 'green');
            }
          }

          var values = _this8._getValuesFromComment(wrapper);

          var buttonLikes = _this8._getElements(_this8.eventElements.comment.buttonLike, wrapper);
          ...
          try {
            for (var _iterator14 = buttonLikes[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
              var buttonLike = _step14.value;
              buttonLike.addEventListener('click', function (e) {
                event({
                  event: 'like',
                  type: type.name,
                  values: [{
                    name: 'postanswer-time',
                    value: values.time
                  }, {
                    name: 'postanswer-count-middle',
                    value: values.countMiddle
                  }, {
                    name: 'postanswer-text',
          ...
          var buttonDislikes = _this8._getElements(_this8.eventElements.comment.buttonDislike, wrapper);
          ...
          try {
            for (var _iterator15 = buttonDislikes[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
              var buttonDislike = _step15.value;
          ...
          try {
            var _loop3 = function _loop3() {
              var buttonComment = _step16.value;

              var buttonC = _this8._getElements(buttonComment.button, wrapper);
              ...
              try {
                for (var _iterator17 = buttonC[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
                  var button = _step17.value;
                  button.addEventListener('click', function (e) {
                    return setTimeout(function () {
                      try {
                        var actionButtons = _this8.getParentElement(e.srcElement, buttonComment.parent);

                        _this8._eventCommentDialog(actionButtons, function (comment) {
                          event({
                            event: 'like',
                            type: type.name,
                            values: [{
            ...
            for (var _iterator16 = _this8.eventElements.comment.buttonComment[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
              _loop3();
            } //for buttonComment
        ...
        for (var _iterator12 = wrappers[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
          _loop2();
        } //for wrappers
      ...
      wrappers = this._getElements(type.query, target, {
        filter: '.tracked:not(.find-replies)',
        addClass: ''
      });
      ...
      try {
        for (var _iterator13 = wrappers[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
          var wrapper = _step13.value;
          ...
          try {
            var _loop4 = function _loop4() {
              ...
              var parentNodes = _this8._getElements(b.parentNode, wrapper, {
                color: 'blue'
              });
              ...
              try {
                var _loop5 = function _loop5() {
                  ...
                  var content = _this8._getElements(b.content, node)[0];
                  ...
                  if (content) {
                    content.addEventListener('DOMSubtreeModified', function () {
                      ...
                      timeout = setTimeout(function () {
                        return _this8._eventCommentLike(content, function (e) {
                          var returnEvent = {
                            event: 'like',
                            type: e.type,
                            values: [{
                          ...
                          try {
                            for (var _iterator20 = e.values[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
                              var v = _step20.value;
                          ...
                          event(returnEvent);
                        }, _this8.eventElements.commentWrapper[1]);
                      }, 500);
                    });
                  }
                };

                for (var _iterator19 = parentNodes[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
                  _loop5();
                } //for parentNodes
            ...
            for (var _iterator18 = this.eventElements.comment.moreCommentFromComments[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
              _loop4();
    ...
    key: "_eventCommentDialog",
    value: function _eventCommentDialog(target) {
      var _this9 = this;

      var fn = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};

      var wrappers = this._getElements(this.eventElements.commentButton.wrapper, target, {
        color: 'green'
      });
      ...
      try {
        var _loop6 = function _loop6() {
          var wrapper = _step21.value;
          var comment = '';

          var inputs = _this9._getElements(_this9.eventElements.commentButton.input, wrapper);
          ...
          try {
            for (var _iterator22 = inputs[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
          ...
          var submits = _this9._getElements(_this9.eventElements.commentButton.submit, wrapper);
          ...
          try {
            for (var _iterator23 = submits[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
              var submit = _step23.value;
        ...
        for (var _iterator21 = wrappers[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
          _loop6();
        } //for
    ...
    value: function _clean_embedded_scripts(target) {
      var selectors = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'script:not([src]),svg,style';
      return YouTubeTracker_get(YouTubeTracker_getPrototypeOf(YouTubeTracker.prototype), "_clean_embedded_scripts", this).call(this, target, selectors + ',dom-module');
    }
    /**
     * [getDom return html content from public articel]
     * @return {String}
    ...
    value: function getDom() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this10._eventSetLike();

        _this10._eventSetDislike();

        _this10._eventSubscribe();

        _this10._eventNewComment();

        setTimeout(function () {
          _this10._eventCommentLike(undefined, function (e) {
            _this10.eventFn.onEvent({
              event: e.event,
              type: e.type,
              values: _this10._getValues().concat(e.values)
            });
          });

          _this10._eventClickHashtag();
        }, 500); // cloning the dom does not work as expected :/
...
function TwitterTracker_createClass(Constructor, protoProps, staticProps) { if (protoProps) TwitterTracker_defineProperties(Constructor.prototype, protoProps); if (staticProps) TwitterTracker_defineProperties(Constructor, staticProps); return Constructor; }
...
function TwitterTracker_setPrototypeOf(o, p) { TwitterTracker_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return TwitterTracker_setPrototypeOf(o, p); }
...
function (_Tracker) {
  ...
  TwitterTracker_createClass(TwitterTracker, [{
    key: "_getValues",
    value: function _getValues(target) {
      var search = [{
        name: 'articel-time',
    ...
    value: function _setAllow() {
      ...
      return new Promise(function (resolve, reject) {
        console.log(_this2.lastURL !== location.pathname, _this2.lastURL, location.pathname);
        ...
        if (_this2.lastUrlPath !== location.pathname) {
          setTimeout(function () {
            ...
            console.log('ALLOW?', _this2.allow);
            resolve(_this2.allow);
          }, 2000);
        } else {
          resolve(_this2.allow);
      ...
      for (var i = 0; i < likeButton.length; i++) {
        likeButton[i].addEventListener('click', function (e) {
          ...
          _this3.eventFn.onEvent({
            event: 'like',
            type: 'articel',
            values: _this3._getValues(_this3.tweetId2Element[id]).concat([{
              name: 'like',
              value: value
            }])
          });
        ...
        if (Object.keys(this.tweetId2Element).includes(id)) {
          ...
          submitButton.addEventListener('click', function (e) {
            _this4.eventFn.onEvent({
              event: 'comment',
              type: 'articel',
              values: _this4._getValues(_this4.tweetId2Element[id]).concat([{
                name: 'comment',
              ...
              for (i = 0; i < submitButtons.length; i++) {
                submitButtons[i].addEventListener('click', function (e) {
                  _this5.eventFn.onEvent({
                    event: 'retweet',
                    type: 'articel',
                    values: _this5._getValues(_this5.tweetId2Element[id]).concat([{
                      name: 'comment',
                      value: content.textContent
                    }])
                  });
    ...
    value: function _eventListenTweetstorm() {
      ...
      if (tweet.length > 0) {
        ...
        if (Object.keys(this.tweetId2Element).includes(id)) {
          ...
          submitButton.addEventListener('click', function (e) {
            var values = _this6._getValues(_this6.tweetId2Element[id]),
                comments = content.map(function (e) {
              return e.textContent;
            }).filter(function (e) {
              return e.length > 0;
            });
    ...
    key: "_eventListenPermalinkOverlay",
      ...
      if (articels.length == 1 && this._isPublic(articels[0])) {
        ...
        submitButton.addEventListener('click', function (e) {
          _this7.eventFn.onEvent({
            event: 'comment',
            type: 'articel',
            values: _this7._getValues(_this7.tweetId2Element[id]).concat([{
              name: 'comment',
              value: content.textContent
            }])
          });
    ...
    **/
    ...
    value: function get_username() {
      ...
      var svg = document.documentElement.querySelector(this.selectors.svg_lists_deactivated);
    ...
    */
    ...
    key: "trackArticle",
    value: function trackArticle(id, article) {
    ...
    key: "_getWhoId",
    value: function _getWhoId(article) {
      try {
        var _clone = article.cloneNode(true);
    ...
    key: "assemblePublicDom",
    value: function assemblePublicDom() {
      var tweet_strings = '';
      var counter = 0;
...
function (_Tracker) {
  ...
  function InstagramTracker(worker, privacy) {
    ...
    _this.svg_share = 'path[d="M46.5 3.5h-45C.6 3.5.2 4.6.8 5.2l16 15.8 5.5 22.8c.2.9 1.4 1 1.8.3L47.4 5c.4-.7-.1-1.5-.9-1.5zm-40.1 3h33.5L19.1 18c-.4.2-.9.1-1.2-.2L6.4 6.5zm17.7 31.8l-4-16.6c-.1-.4.1-.9.5-1.1L41.5 9 24.1 38.3z"]';
    _this.svg_like = 'path[d="M34.3 3.5C27.2 3.5 24 8.8 24 8.8s-3.2-5.3-10.3-5.3C6.4 3.5.5 9.9.5 17.8s6.1 12.4 12.2 17.8c9.2 8.2 9.8 8.9 11.3 8.9s2.1-.7 11.3-8.9c6.2-5.5 12.2-10 12.2-17.8 0-7.9-5.9-14.3-13.2-14.3zm-1 29.8c-5.4 4.8-8.3 7.5-9.3 8.1-1-.7-4.6-3.9-9.3-8.1-5.5-4.9-11.2-9-11.2-15.6 0-6.2 4.6-11.3 10.2-11.3 4.1 0 6.3 2 7.9 4.2 3.6 5.1 1.2 5.1 4.8 0 1.6-2.2 3.8-4.2 7.9-4.2 5.6 0 10.2 5.1 10.2 11.3 0 6.7-5.7 10.8-11.2 15.6z"]';
    ...
    _this.mosaik = 'div.v1Nh3.kIKUG._bz0w';
    _this.articleId2Element = {};
    _this.mosaikId2Element = {};
    _this.logged_user_id = null;
    _this.logged_username = null;
    _this.logged_fullname = null;
    _this.profile_pic_url = null;
    _this.profile_pic_url_hd = null;
    _this.credentials = null;
    _this.is_logged_in = null;
    _this.is_timeline = false;
    _this.is_explore = false;
  ...
  InstagramTracker_createClass(InstagramTracker, [{
    ...
    */
    ...
    key: "getMetadata",
    value: function getMetadata() {
      var metadata = InstagramTracker_get(InstagramTracker_getPrototypeOf(InstagramTracker.prototype), "getMetadata", this).call(this);
    ...
    **/
    ...
    key: "get_svg_account",
    value: function get_svg_account() {
      return document.querySelector(this.svg_account);
    }
  }, {
    key: "get_fullname",
    value: function get_fullname() {
      var element = document.querySelector(this.div_fullname);
    ...
    key: "get_username",
    value: function get_username(svg_account) {
      if (svg_account) {
    ...
    key: "_isLogged",
    value: function _isLogged(svg_account) {
      if (svg_account) {
        return true;
      }
    ...
    */
    ...
    key: "_getMosaikId",
    value: function _getMosaikId(mosaik) {
      var _id = null;
    ...
    key: "trackMosaik",
    value: function trackMosaik(id, article) {
    ...
    value: function addPublicArticles() {
      ...
      var articles = document.querySelectorAll(this.article);
      var counter = 0;
    ...
    key: "addArticleMosaik",
    value: function addArticleMosaik() {
      var mosaiks = document.querySelectorAll(this.mosaik);
      var counter = 0;

      for (var i = 0; i < mosaiks.length; i++) {
        var id = this._getMosaikId(mosaiks[i]);
    ...
    key: "reAssembleDom",
    value: function reAssembleDom() {
      var dom = this.__getDom(); //this.timeline_body = 'div.cGcGK > div > div';
      ...
      if (this.is_explore || this.is_profile) {
        ...
        if (one_mosaik) {
          var mosaik_body = one_mosaik.parentNode.parentNode;
...
// CONCATENATED MODULE: ./src/content/addon/DomainTracker.js
function DomainTracker_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { DomainTracker_typeof = function _typeof(obj) { return typeof obj; }; } else { DomainTracker_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return DomainTracker_typeof(obj); }

function DomainTracker_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function DomainTracker_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function DomainTracker_createClass(Constructor, protoProps, staticProps) { if (protoProps) DomainTracker_defineProperties(Constructor.prototype, protoProps); if (staticProps) DomainTracker_defineProperties(Constructor, staticProps); return Constructor; }

function DomainTracker_possibleConstructorReturn(self, call) { if (call && (DomainTracker_typeof(call) === "object" || typeof call === "function")) { return call; } return DomainTracker_assertThisInitialized(self); }

function DomainTracker_getPrototypeOf(o) { DomainTracker_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return DomainTracker_getPrototypeOf(o); }

function DomainTracker_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function DomainTracker_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) DomainTracker_setPrototypeOf(subClass, superClass); }

function DomainTracker_setPrototypeOf(o, p) { DomainTracker_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return DomainTracker_setPrototypeOf(o, p); }
...
function (_Tracker) {
  ...
  DomainTracker_createClass(DomainTracker, [{
    key: "getMetadata",
    value: function getMetadata() {
      return {
        description: [],
...
function DomDetector_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function DomDetector_createClass(Constructor, protoProps, staticProps) { if (protoProps) DomDetector_defineProperties(Constructor.prototype, protoProps); if (staticProps) DomDetector_defineProperties(Constructor, staticProps); return Constructor; }

var DomDetector =
/*#__PURE__*/
function () {
  function DomDetector() {
    DomDetector_classCallCheck(this, DomDetector);
  ...
  DomDetector_createClass(DomDetector, [{
    ...
    */
    ...
    value: function onChange(fn) {
      var newdelay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.delay;
      this.delay = newdelay;
      this.stack.push(fn);
    }
  }, {
    key: "_naive",
    value: function _naive() {
    ...
    key: "_decide",
    value: function _decide() {
      if (this.support.DOMNodeInserted) {
        if (this.support.DOMSubtreeModified) {
          // for FF 3+, Chrome
...
function () {
  ...
  ContentHandler_createClass(ContentHandler, [{
    ...
    key: "contextmenu_recorder",
    value: function contextmenu_recorder() {
    ...
    */
    ...
    value: function sendMessage() {
      ...
      if (object.hasOwnProperty('html')) {
        ...
        type = 'html';
      } else if (object.hasOwnProperty('links')) {// object = {links: this.data.links.concat(object.links)}
        // type = 'links';
        ...
        object = {
          events: this.data.events.concat([object])
        };
        type = 'event';
      }
