...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return DomainTracker; });\n/* harmony import */ var _Tracker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Tracker */ \"./src/content/Tracker.js\");\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\n\n\nvar DomainTracker =\n/*#__PURE__*/\nfunction (_Tracker) {\n  _inherits(DomainTracker, _Tracker);\n\n  function DomainTracker(worker) {\n    var _this;\n\n    var extensionfilter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];\n\n    _classCallCheck(this, DomainTracker);\n\n    _this = _possibleConstructorReturn(this, _getPrototypeOf(DomainTracker).call(this, worker));\n    _this.extensionfilter = extensionfilter;\n    _this.onStart = _this.onStart.bind(_assertThisInitialized(_this));\n    _this.is_allowed = null;\n    return _this;\n  }\n  /**\n   * get the metadata from the file\n   * @return {object} the metadata of the html\n   */\n\n\n  _createClass(DomainTracker, [{\n    key: \"getMetadata\",\n    value: function getMetadata() {\n      return {\n        description: [],\n        keywords: [],\n        full_anonym: true\n      };\n    }\n    /**\n     * [isAllow returns if the path is allowed in social media platforms]\n     * @param  {Location}  [the location element to analyze the url]\n     * @return {Boolean}   [if it is allow according to social media platforms rules]\n     */\n\n  }, {\n    key: \"is_path_allow\",\n    value: function is_path_allow(path) {\n      return false;\n    }\n    /**\n     * [onStart on start event]\n     * @param  {Function} fn\n     */\n\n  }, {\n    key: \"onStart\",\n    value: function onStart(fn) {\n      var _this2 = this;\n\n      setTimeout(function () {\n        if (_this2.debug) console.log('START!!!!');\n        fn(1000);\n      }, 500);\n    }\n  }]);\n\n  return DomainTracker;\n}(_Tracker__WEBPACK_IMPORTED_MODULE_0__[\"default\"]); //class\n\n\n\n\n//# sourceURL=webpack:///./src/content/addon/DomainTracker.js?");

/***/ }),

/***/ "./src/content/addon/FacebookTracker.js":
/*!**********************************************!*\
  !*** ./src/content/addon/FacebookTracker.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babel_polyfill__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _ContentHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ContentHandler */ \"./src/content/ContentHandler.js\");\n\n\nvar content = new _ContentHandler__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\ncontent.init();\n\n//# sourceURL=webpack:///./src/content/index.js?");
